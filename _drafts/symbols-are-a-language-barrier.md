---
title: "Symbols are a language barrier"
category: "essays"
---

> Note: If you're reading this and know English as a non-primary language I want to apologize while it might read as if I think "English is the best for programming", but I do not believe this to be true. There is nothing to my knowledge that makes English good for programming, but instead I make this commentary because I only know English. If I only knew Spanish or French I would probably have that in place of English.
...
``` forth
core_materials special_materials join
```
